* [OrgIdInterface_1_1_5](#orgidinterface_1_1_5)
...
# OrgIdInterface_1_1_5


## *function* acceptDirectorship

OrgIdInterface_1_1_5.acceptDirectorship(orgId) `nonpayable` `781a9601`
...
OrgIdInterface_1_1_5.createOrganization(salt, orgJsonHash, orgJsonUri, orgJsonUriBackup1, orgJsonUriBackup2) `nonpayable` `b2c23371`
...
OrgIdInterface_1_1_5.createUnit(salt, parentOrgId, director, orgJsonHash, orgJsonUri, orgJsonUriBackup1, orgJsonUriBackup2) `nonpayable` `bf042ef2`
...
OrgIdInterface_1_1_5.getOrganization(_orgId) `view` `22b3cd4e`
...
OrgIdInterface_1_1_5.getOrganizations(includeInactive) `view` `0c70d7c5`
...
OrgIdInterface_1_1_5.getUnits(parentOrgId, includeInactive) `view` `0dd56c93`
...
OrgIdInterface_1_1_5.renounceDirectorship(orgId) `nonpayable` `096dde02`
...
OrgIdInterface_1_1_5.setOrgJson(orgId, orgJsonHash, orgJsonUri, orgJsonUriBackup1, orgJsonUriBackup2) `nonpayable` `3b331384`
...
OrgIdInterface_1_1_5.toggleActiveState(orgId) `nonpayable` `0209c0ef`
...
OrgIdInterface_1_1_5.transferDirectorship(orgId, newDirector) `nonpayable` `a954f145`
...
OrgIdInterface_1_1_5.transferOrganizationOwnership(orgId, newOwner) `nonpayable` `aa73697e`
