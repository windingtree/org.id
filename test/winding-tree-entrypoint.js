...
contract('WindingTreeEntrypoint', (accounts) => {
    ...
    describe('#initialize', () => {
        ...
        it('should set liftoken', async () => {
            ...
            await entrypoint
                .methods
                .initialize(windingTreeEntrypointOwner, tokenFakeAddress)
                .send({
                    from: windingTreeEntrypointOwner
                });
            assert.equal(
    ...
    describe('setSegment', () => {
        ...
        it('should set a segment and emit', async () => {
            ...
            assert.equal(
                await windingTreeEntrypoint.methods
                    .getSegmentsLength().call(),
                2
            );
            assert.equal(
                await windingTreeEntrypoint.methods
                    .getSegmentsIndex('hotels').call(),
                1
            );
            assert.equal(
    ...
    describe('#getSegmentsIndex', () => {
        ...
        it('should return segment index', async () => {
            ...
            assert.equal(
                await windingTreeEntrypoint.methods
                    .getSegmentsIndex('airlines').call(),
                2
            );
        });
