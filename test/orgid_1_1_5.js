...
const OrgIdContract = Contracts.getFromLocal('OrgId_1_1_5');
const OrgIdUpgradeabilityContract = Contracts.getFromLocal('OrgId_1_1_5_Upgradeability');

require('chai')
    .use(require('bn-chai')(web3.utils.BN))
    .should();

contract('OrgId_1_1_5', accounts => {
    ...
    describe('OrgId upgradeability', () => {
        ...
        before(async () => {
            orgIdContractInstance = await deployContract(project, OrgIdContract);
    ...
    describe('OrgId methods', () => {
        ...
        describe('#getOrganizations(bool)', () => {
            ...
            before(async () => {
                newOrgIdContractInstance = await deployContract(project, OrgIdContract);
            });
